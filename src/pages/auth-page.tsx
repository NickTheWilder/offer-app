  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.formContainer}>
        <div className={styles.card}>
          <div className={styles.cardHeader}>
            ...
            <h2 className={styles.cardTitle}>Church Bazaar Auction</h2>
            <button
              type="button"
            ...
            <div className={styles.tabContainer}>
              ...
              <div className={`${styles.tabContent} ${activeTab === 'register' ? styles.active : ''}`}>
                <form onSubmit={registerForm.handleSubmit(onRegisterSubmit)}>
                  ...
                  <div className={styles.formGroup}>
                    <label htmlFor="bidderNumber" className={styles.label}>Bidder Number</label>
                    <input 
                      id="bidderNumber"
                      type="text" 
                      placeholder="B123"
                      className={styles.input}
                      {...registerForm.register("bidderNumber")}
                    />
                    {registerForm.formState.errors.bidderNumber && (
                      <div className={styles.errorMessage}>
                        {registerForm.formState.errors.bidderNumber.message}
                      </div>
                    )}
                  </div>
      ...
      <div className={styles.heroContainer}>
        <h1 className={styles.heroTitle}>Welcome to the Church Bazaar Auction</h1>
        <p className={styles.heroDesc}>
          Participate in our silent auction to support our community projects.
          Browse items, place bids, and track your auction activity all in one place.
        </p>
