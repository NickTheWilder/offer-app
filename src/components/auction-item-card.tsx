...
export default function AuctionItemGrid({ items, onBidClick, onBuyNowClick }: AuctionItemProps) {
  const { user } = useAuth();
  ...
  const getUserBidStatus = (itemId: number) => {
    ...
    return {
      ...
      isWinning: highestUserBid.isWinning
    };
  };
    ...
    <div className={styles.gridContainer}>
      {items.map((item) => {
        ...
        const badgeType = userBidStatus
          ? (userBidStatus.isWinning ? "winning" : "outbid")
          : "active";
                ...
                <div className={styles.userBidInfo}>
                  {userBidStatus ? (
                    <>
                      ...
                      <p className={userBidStatus.isWinning ? styles.userBidWinning : styles.userBidOutbid}>
