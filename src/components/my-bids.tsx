...
export default function MyBids() {
  // Fetch user's bids
  const { data: bids, isLoading, error } = useQuery<BidWithItem[]>({
      ...
      <div className={styles.bidsGrid}>
        ...
        {winningBids.map(bid => (
          <div key={bid.id} className={`${styles.bidCard} ${styles.winningCard}`}>
            <div className={`${styles.statusBadge} ${styles.winningBadge}`}>
              Winning
            </div>
        ...
        {outbidBids.map(bid => (
          <div key={bid.id} className={`${styles.bidCard} ${styles.outbidCard}`}>
            <div className={`${styles.statusBadge} ${styles.outbidBadge}`}>
              Outbid
            </div>
            <div className={styles.itemHeader}>
              <div className={styles.imageContainer}>
