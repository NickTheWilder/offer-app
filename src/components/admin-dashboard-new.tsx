...
import { PlusCircle, Loader2, Edit, Trash2, Check, X, ChevronDown } from "lucide-react";
                ...
                <form onSubmit={form.handleSubmit(onSubmit)} className={styles.itemForm}>
                    ...
                    <div className={styles.formLeftColumn}>
                      ...
                      <div className={styles.formGroup}>
                        ...
                        {form.formState.errors.name && (
                          <p className={styles.formError}>{form.formState.errors.name.message}</p>
                        )}
                      </div>
                      ...
                      <div className={styles.formGroup}>
                        ...
                        {form.formState.errors.startingBid && (
                          <p className={styles.formError}>{form.formState.errors.startingBid.message}</p>
                        )}
                      </div>
                      ...
                      <div className={styles.formGroup}>
                        ...
                        {form.formState.errors.buyNowPrice && (
                          <p className={styles.formError}>{form.formState.errors.buyNowPrice.message}</p>
                        )}
                      </div>
                      ...
                      <div className={styles.formGroup}>
                        ...
                        {form.formState.errors.category && (
                          <p className={styles.formError}>{form.formState.errors.category.message}</p>
                        )}
                      </div>
                    </div>
                      ...
                      <div className={styles.imagePreview}>
                        {(() => {
                          ...
                          if (images && images.length > 0) {
                            ...
                            return (
                              <div className={styles.noPreviewImage}>No image available</div>
                            );
                          }
                        })()}
                      </div>
                  ...
                  <div className={styles.formGroup}>
                    ...
                    {form.formState.errors.description && (
                      <p className={styles.formError}>{form.formState.errors.description.message}</p>
                    )}
                  </div>
