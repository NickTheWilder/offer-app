...
import type { User, AuctionItem, Sale } from "@/types";
...
export default function EditSaleModal({ isOpen, onClose, sale, users, items }: EditSaleModalProps): JSX.Element | null {
    ...
    useEffect(() => {
        if (sale) {
            setFormData({
                ...
                auction_item_id: sale.auction_item_id?.toString() || "",
    ...
    const handleSubmit = (e: FormEvent) => {
        ...
        router.put(`/admin/sales/${sale.id}`, formData, {
            preserveScroll: true,
            onSuccess: () => {
        ...
        <div className={styles.modalOverlay} onClick={onClose}>
            <div className={styles.modalContent} onClick={(e) => e.stopPropagation()}>
                <div className={styles.modalHeader}>
                    <h2 className={styles.modalTitle}>Edit Sale</h2>
